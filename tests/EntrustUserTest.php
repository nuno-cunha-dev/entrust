...
class EntrustUserTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testHasRole()
    {
        ...
        */
        ...
        $user = $this->getUserMock(['getCachedRoles']);
        ...
        |------------------------------------------------------------
        */
        $user->shouldReceive('getCachedRoles')->times(9)->andReturn(new Collection([$roleA, $roleB]));
    ...
    public function testCan()
    {
        ...
        */
        ...
        |------------------------------------------------------------
        */
        $user->shouldReceive('getCachedRoles')->times(11)->andReturn(new Collection([$roleA, $roleB]));
    ...
    public function testCanWithPlaceholderSupport()
    {
        ...
        */
        ...
        |------------------------------------------------------------
        */
        $user->shouldReceive('getCachedRoles')->times(6)->andReturn(new Collection([$role]));
    ...
    public function testAbilityShouldReturnBoolean()
    {
        ...
        */
        ...
        $user->shouldReceive('getCachedRoles')->times(32)->andReturn(new Collection([$roleA, $roleB]));
    ...
    public function testAbilityShouldAcceptStrings()
    {
        ...
        */
        ...
        $user->shouldReceive('getCachedRoles')->times(8)->andReturn(new Collection([$roleA, $roleB]));
        $user->shouldReceive('hasRole')
    ...
    /**
     * @param $mockMethods
     * @return HasRoleUser|m\Mock
     */
    private function getUserMock($mockMethods = []) {
        return m::mock("HasRoleUser[" . join($mockMethods, ',') . "]")
